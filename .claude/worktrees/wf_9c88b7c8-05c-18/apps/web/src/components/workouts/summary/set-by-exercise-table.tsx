    ...
    <Card>
      ...
      <CardContent className="px-0 pt-0">
        <table className="w-full text-sm tabular-nums">
          <thead>
            <tr className="border-border-strong text-text-tertiary border-b text-[10px] font-semibold uppercase tracking-[0.1em]">
                ...
                return (
                  ...
                  >
                    <td
                      className={cn(
                        "px-4 py-3",
                        isPr ? "border-pr border-l-[3px] pl-3" : "",
                      )}
                    >
                      {idx === 0 ? (
                    ...
                    <td className="text-text-secondary font-serif px-2 py-3">
                      {setLabel}
                    </td>
                    <td className="font-serif px-2 py-3 text-right">{dec(set.weight_kg)}</td>
                    <td className="font-serif px-2 py-3 text-right">{dec(set.reps)}</td>
                    <td className="font-serif px-2 py-3 pr-4 text-right">{dec(set.rpe)}</td>
                  </tr>
                );
              });
            })}
